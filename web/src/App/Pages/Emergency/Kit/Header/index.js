    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.danger}>
          ...
          <br /> Debes imprimir y guardar en un lugar seguro este documento ya que esta información
          es de vital importancia para que puedas entrar en la plataforma y recuperar tus archivos.
        </div>
