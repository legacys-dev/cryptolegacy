  ...
  renderButtons() {
    ...
    return (
      <div className={styles.buttons}>
        <Button primary onClick={() => history.push(`/vaults/invitations/${vault._id}/create`)}>
          {translate('vaults.createInvitation')}
        </Button>
      </div>
    )
  }
  ...
  render() {
    ...
    return (
      <div className={styles.container}>
        <Header
          past={{ [`/vaults/storage-update/${vault._id}`]: translate('vaults.invitations') }}
