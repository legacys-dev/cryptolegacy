...
export default {
  ...
  notAnInteger: ({ label, placeholder }) =>
    `${message(label, placeholder)} no es un nuúmero entero`,
  ...
  numberTooBig: ({ label, placeholder }) =>
    `${message(label, placeholder)} es un número muy grande`,
  ...
  userHasInvitation: ({ label, placeholder }) => 'Ya existe una invitación para este usuario',
