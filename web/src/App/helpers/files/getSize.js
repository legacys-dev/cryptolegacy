...
export default function(size) {
  ...
  if (size >= 1024 * 1024 && size < 1024 * 1024 * 1000) { return `${numeral(size / 1024).format('0,0')} MB` }

  if (size >= 1024 * 1024 * 1000 && size < 1024 * 1024 * 1000 * 1000) { return `${numeral(size / 1024).format('0,0')} GB` }
